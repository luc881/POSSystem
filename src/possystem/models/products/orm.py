...
class Product(Base):
    ...
    brand_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("product_brands.id", ondelete="RESTRICT"), nullable=True)
    product_master_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("product_master.id", ondelete="SET NULL"), nullable=True)
